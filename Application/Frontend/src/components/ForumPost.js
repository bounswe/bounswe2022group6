...
const mockPosts = [
  ...
  },
  {
    id: 2,
    userName: "Mehmet",
    title: "I am 17 and a week ago I almost passed out",
    date: "12",
    description:
  ...
  },
  {
    id: 3,
    userName: "Mert",
    title: "Hello everyone. I took parol pills",
    date: "20",
    description:
  ...
  },
  {
    id: 4,
    userName: "Hasan",
    title: "Overtaking 45mg Mirtazapine for 6 months straight",
    date: "40",
    description:
  ...
  },
  {
    id: 5,
    userName: "Fatma",
    title: "Misdiagnosed tennis elbow?So i've had this lingering elbow ",
    date: "50",
    description:
  ...
  },
  {
    id: 6,
    userName: "Burak",
    title: "Odd eye spasm when trying to sleep  this has been happening ",
    date: "55",
    description:
  ...
  },
  {
    id: 7,
    userName: "Berk",
    title: "Still have a have a fever 2 weeks after recovering from possibl",
    date: "59",
    description:
  ...
  return (
    <div className={styles.mypost}>
      <div className={styles.mypostright}>
        <ImArrowUp
          className={props.voted === "up" ? styles.upvoteactive : styles.upvote}
          onClick={() => vote("up")}
        />
        <h3
          style={{
        ...
        <ImArrowDown
          className={
            props.voted === "down" ? styles.downvoteactive : styles.downvote
          }
          onClick={() => vote("down")}
        />
      </div>
      ...
      >
        <div>
          ...
          >
            <div  style={{ textAlign: "left", fontWeight: "bolder",fontSize:"larger" }}>
              
              {props.userName}
            <small style={{ padding: "3px 5px",fontWeight: "lighter",fontSize:"11px"  }}>
                {"posted " + props.date + " minute ago"}
              </small></div>
        ...
        <p style={{ textAlign: "left", fontWeight: "bolder" }}>{props.title}</p>
...
const Posts = () => {
  ...
  return (
    ...
    >
      {!isGuestUser && !showPostCreate && (
        <div className={styles.createpost} onClick={handleClick}>
          Create Post
        </div>
      )}
      {showPostCreate && (
        <CreatePostForm onCancel={() => setPostCreate(false)}></CreatePostForm>
      )}
